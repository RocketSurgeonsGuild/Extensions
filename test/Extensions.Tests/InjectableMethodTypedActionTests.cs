...
{
    public class InjectableMethodTypedActionTests
    {
        [Fact]
        public void MapsActionAndExecutes()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest>();
        ...
        public void MapsConfiguredParameterToAction()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IConfigured1>();
        ...
        public void MapsInstanceParameterToAction()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IInstance>();
        ...
        public void Configures1Service()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IConfigured1, IInstance>();
        ...
        public void Configures2Services()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IConfigured1, IConfigured2, IInstance>();
        ...
        public void Configures3Services()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IConfigured1, IConfigured2, IConfigured3, IInstance>();
        ...
        public void Configures4Services()
        {
            ...
            var action = method.CreateTypedAction<MethodFuncTest, IConfigured1, IConfigured2, IConfigured3, IConfigured4, IInstance>();
            action(methodFuncTestMock, serviceProvider, A.Fake<IConfigured1>(), A.Fake<IConfigured2>(),
        ...
        public void Configures5Services()
        {
            ...
            var action = method
                .CreateTypedAction<MethodFuncTest, IConfigured1, IConfigured2, IConfigured3, IConfigured4, IConfigured5, IInstance>();
            action(methodFuncTestMock, serviceProvider, A.Fake<IConfigured1>(), A.Fake<IConfigured2>(),
        ...
        public void Configures6Services()
        {
            ...
            var action = method
                .CreateTypedAction<MethodFuncTest, IConfigured1, IConfigured2, IConfigured3, IConfigured4, IConfigured5, IConfigured6,
                    IInstance>();
            action(methodFuncTestMock, serviceProvider, A.Fake<IConfigured1>(), A.Fake<IConfigured2>(),
