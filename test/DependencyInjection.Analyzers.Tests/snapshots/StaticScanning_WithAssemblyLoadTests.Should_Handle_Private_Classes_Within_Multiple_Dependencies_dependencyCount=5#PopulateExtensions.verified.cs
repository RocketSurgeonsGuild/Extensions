...
namespace Rocket.Surgery.DependencyInjection.Compiled
{
    ...
    internal static class PopulateExtensions
    {
        public static IServiceCollection Populate(IServiceCollection services, RegistrationStrategy strategy, string filePath, string memberName, int lineNumber)
        {
            switch (lineNumber)
            {
                case 14:
                    ...
                    strategy.Apply(services, ServiceDescriptor.Describe(typeof(RootDependencyProject.IService), Assembly.Load(Dependency1ProjectVersion0000CultureneutralPublicKeyTokennull).GetType("Dependency1Project.Service1"), ServiceLifetime.Singleton));
                    strategy.Apply(services, ServiceDescriptor.Describe(typeof(RootDependencyProject.IService), Assembly.Load(Dependency2ProjectVersion0000CultureneutralPublicKeyTokennull).GetType("Dependency1Project.Service2"), ServiceLifetime.Singleton));
                    strategy.Apply(services, ServiceDescriptor.Describe(typeof(RootDependencyProject.IService), Assembly.Load(Dependency3ProjectVersion0000CultureneutralPublicKeyTokennull).GetType("Dependency1Project.Service3"), ServiceLifetime.Singleton));
                    strategy.Apply(services, ServiceDescriptor.Describe(typeof(RootDependencyProject.IService), Assembly.Load(Dependency4ProjectVersion0000CultureneutralPublicKeyTokennull).GetType("Dependency1Project.Service4"), ServiceLifetime.Singleton));
                    break;
            }
        ...
        private static AssemblyName _Dependency4ProjectVersion0000CultureneutralPublicKeyTokennull;
        private static AssemblyName Dependency4ProjectVersion0000CultureneutralPublicKeyTokennull => _Dependency4ProjectVersion0000CultureneutralPublicKeyTokennull ??= new AssemblyName("Dependency4Project, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null");
    }
}
