    ...
    Microsoft.Extensions.DependencyInjection.IServiceCollection ICompiledTypeProvider.Scan(Microsoft.Extensions.DependencyInjection.IServiceCollection services, Action<IServiceDescriptorAssemblySelector> selector, int lineNumber, string filePath, string argumentExpression)
    {
        switch (lineNumber)
        {
            ...
            case 20:
                ...
                services.Add(ServiceDescriptor.Transient(typeof(global::Service), a => a.GetRequiredService<global::Service>()));
                ...
                services.Add(ServiceDescriptor.Transient(typeof(global::ServiceA), a => a.GetRequiredService<global::ServiceA>()));
                services.Add(ServiceDescriptor.Singleton(typeof(global::IService), a => a.GetRequiredService<global::ServiceB>()));
                services.Add(ServiceDescriptor.Singleton(typeof(global::ServiceB), a => a.GetRequiredService<global::ServiceB>()));
