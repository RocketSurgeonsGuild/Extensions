    ...
    Microsoft.Extensions.DependencyInjection.IServiceCollection ICompiledTypeProvider.Scan(Microsoft.Extensions.DependencyInjection.IServiceCollection services, Action<IServiceDescriptorAssemblySelector> selector, int lineNumber, string filePath, string argumentExpression)
    {
        switch (lineNumber)
        {
            ...
            case 29:
                ...
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.CodeAnalysis.FeatureGuardAttribute"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.CodeAnalysis.FeatureGuardAttribute")));
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.CodeAnalysis.FeatureSwitchDefinitionAttribute"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.CodeAnalysis.FeatureSwitchDefinitionAttribute")));
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.DebuggerDisableUserUnhandledExceptionsAttribute"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Diagnostics.DebuggerDisableUserUnhandledExceptionsAttribute")));
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Runtime.CompilerServices.OverloadResolutionPriorityAttribute"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Runtime.CompilerServices.OverloadResolutionPriorityAttribute")));
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Runtime.CompilerServices.ParamCollectionAttribute"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Runtime.CompilerServices.ParamCollectionAttribute")));
                ...
                services.Add(ServiceDescriptor.Scoped(RocketSurgeryDependencyInjectionExtensions.GetType("System.Threading.Lock"), RocketSurgeryDependencyInjectionExtensions.GetType("System.Threading.Lock")));
