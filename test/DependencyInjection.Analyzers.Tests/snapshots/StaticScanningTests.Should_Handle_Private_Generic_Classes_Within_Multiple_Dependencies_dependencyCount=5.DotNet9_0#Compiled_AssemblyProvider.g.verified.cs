    ...
    Microsoft.Extensions.DependencyInjection.IServiceCollection ICompiledTypeProvider.Scan(Microsoft.Extensions.DependencyInjection.IServiceCollection services, Action<IServiceDescriptorAssemblySelector> selector, int lineNumber, string filePath, string argumentExpression)
    {
        switch (lineNumber)
        {
            ...
            case 15:
                ...
                services.Add(ServiceDescriptor.Singleton(typeof(RootDependencyProject.IRequestHandler<, >).MakeGenericType(Dependency1Project.GetType("Dependency1Project.Request1"), Dependency1Project.GetType("Dependency1Project.Response1")), Dependency1Project.GetType("Dependency1Project.RequestHandler1")));
                services.Add(ServiceDescriptor.Singleton(typeof(RootDependencyProject.IRequestHandler<, >).MakeGenericType(typeof(global::Dependency1Project.Request2), typeof(global::Dependency1Project.Response2)), typeof(global::Dependency1Project.RequestHandler2)));
                services.Add(ServiceDescriptor.Singleton(typeof(RootDependencyProject.IRequestHandler<, >).MakeGenericType(Dependency3Project.GetType("Dependency1Project.Request3"), Dependency3Project.GetType("Dependency1Project.Response3")), Dependency3Project.GetType("Dependency1Project.RequestHandler3")));
                services.Add(ServiceDescriptor.Singleton(typeof(RootDependencyProject.IRequestHandler<, >).MakeGenericType(typeof(global::Dependency1Project.Request4), typeof(global::Dependency1Project.Response4)), typeof(global::Dependency1Project.RequestHandler4)));
                break;
        }
