    ...
    Microsoft.Extensions.DependencyInjection.IServiceCollection ICompiledTypeProvider.Scan(Microsoft.Extensions.DependencyInjection.IServiceCollection services, Action<IServiceDescriptorAssemblySelector> selector, int lineNumber, string filePath, string argumentExpression)
    {
        switch (lineNumber)
        {
            ...
            case 15:
                ...
                services.Add(ServiceDescriptor.Singleton(RootDependencyProject.GetType("RootDependencyProject.IRequestHandler`2").MakeGenericType(Dependency3Project.GetType("Dependency1Project.Request3"), Dependency3Project.GetType("Dependency1Project.Response3")), Dependency3Project.GetType("Dependency1Project.RequestHandler3")));
