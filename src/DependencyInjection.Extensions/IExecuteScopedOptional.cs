...
/// </summary>
public interface IExecuteScopedOptional<out T>
    where T : notnull
{
    /// <summary>
    ///     Invoke the specified action with the scoped dependency
...
/// </summary>
public interface IExecuteScopedOptional<out T1, out T2>
    where T1 : notnull
    where T2 : notnull
{
    /// <summary>
...
///     Execution of a set of dependencies from a scope that is automatically disposed after execution
/// </summary>
public interface IExecuteScopedOptional<out T1, out T2, out T3>
    where T1 : notnull
    where T2 : notnull
    where T3 : notnull
{
...
///     Execution of a set of dependencies from a scope that is automatically disposed after execution
/// </summary>
public interface IExecuteScopedOptional<out T1, out T2, out T3, out T4>
    where T1 : notnull
    where T2 : notnull
    where T3 : notnull
    where T4 : notnull
...
///     Execution of a set of dependencies from a scope that is automatically disposed after execution
/// </summary>
public interface IExecuteScopedOptional<out T1, out T2, out T3, out T4, out T5>
    where T1 : notnull
    where T2 : notnull
    where T3 : notnull
    where T4 : notnull
...
///     Execution of a set of dependencies from a scope that is automatically disposed after execution
/// </summary>
public interface IExecuteScopedOptional<out T1, out T2, out T3, out T4, out T5, out T6>
    where T1 : notnull
    where T2 : notnull
    where T3 : notnull
    where T4 : notnull
