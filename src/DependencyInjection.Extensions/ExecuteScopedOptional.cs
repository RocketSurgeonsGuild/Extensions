...
{
    internal class ExecuteScopedOptional<T> : IExecuteScopedOptional<T>
        where T : notnull
    {
        private readonly IServiceScopeFactory _serviceScopeFactory;

        public ExecuteScopedOptional(IServiceScopeFactory serviceScopeFactoryFactory) => _serviceScopeFactory = serviceScopeFactoryFactory;
