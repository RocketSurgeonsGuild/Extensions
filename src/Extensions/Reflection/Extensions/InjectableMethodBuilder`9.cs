...
namespace Rocket.Surgery.Reflection.Extensions
{
    public class InjectableMethodBuilder<TContainer, T, T2, T3, T4, T5, T6, T7, T8> : InjectableMethodBuilderBase
    {
        ...
        {
            return new InjectableMethodBuilder<TContainer, T, T2, T3, T4, T5, T6, T7, T8>(MethodNames.Add(methodName));
        }

        public Func<TContainer, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, TResult> Compile<TResult>()
        {
            ...
            var lambda = Expression.Lambda<Func<TContainer, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, TResult>>(body, parameters);
            return lambda.Compile();
        }

        public Action<TContainer, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8> Compile()
        {
            var (body, parameters) = base.Compile(
                typeof(T).GetTypeInfo(),
                typeof(T2).GetTypeInfo(),
                ...
                typeof(T7).GetTypeInfo(),
                typeof(T8).GetTypeInfo());
            var lambda = Expression.Lambda<Action<TContainer, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8>>(body, parameters);
            return lambda.Compile();
        }
    }
}
