...
public class InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9> : InjectableMethodBuilderBase
{
    ...
    /// <returns></returns>
    public InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9, TNext> WithParameter<TNext>() => new(Container, MethodNames);
    ...
    /// <returns></returns>
    public InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9> ForMethod(string methodName) => new(Container, MethodNames.Add(methodName));
