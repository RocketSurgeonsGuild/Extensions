...
public class InjectableMethodBuilder<T, T2, T3, T4> : InjectableMethodBuilderBase
{
    ...
    )
    {
        ...
        {
            return new InjectableMethodBuilder<T, T2, T3, T4, TNext>(Container, MethodName /// <summary>
            ...
            {
                return new InjectableMethodBuilder<T, T2, T3, T4>(Container, MethodNames.Add(method /// <summary>
