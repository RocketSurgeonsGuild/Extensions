...
namespace Rocket.Surgery.Reflection
{
    internal static class TypeExtensions
    {
        ...
        {
            return TypesAssignableFrom(@this).Any(t => IntrospectionExtensions.GetTypeInfo(t).IsGenericType && !@this.GetTypeInfo().ContainsGenericParameters && t.GetGenericTypeDefinition() == openGeneric);
        }
