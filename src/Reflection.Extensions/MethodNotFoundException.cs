...
#pragma warning restore CA1819 // Properties should not return arrays
    ...
    public MethodNotFoundException(string[] methodNames, Exception innerException) : base(
        "Method not found! Looking for methods: " + string.Join(", ", methodNames), innerException
    )
    {
        MethodNames = methodNames;
    }
