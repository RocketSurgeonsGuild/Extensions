...
public class InjectableMethodBuilder<T, T2, T3, T4, T5, T6> : InjectableMethodBuilderBase
{
    ...
    )
    {
        ...
        {
            return new InjectableMethodBuilder<T, T2, T3, T4, T5, T6, TNext>(Container, MethodName /// <summary>
            ...
            {
                return new InjectableMethodBuilder<T, T2, T3, T4, T5, T6>(Container, MethodNames.Add(method /// <summary>
                ...
                public Func<object, IServiceProvider, T, T2, T3, T4, T5, T6, TResult> Compile<TResult>()
                {
                    ...
                    return lambda.CompileFast < Func<object, IServiceProvider, T, T2, T3, T4, T5, T6, TResult> > /// <summary>
                    ...
                    public Action<object, IServiceProvider, T, T2, T3, T4, T5, T6> Compile()
                    {
                        ...
                        return lambda.CompileFast<Action<object, IServiceProvider, T, T2, T3, T4, T5, T6>>();
                        ...
                        public Func<IServiceProvider, T, T2, T3, T4, T5, T6, TResult> CompileStatic<TResult>()
                        {
                            ...
                            return lambda.CompileFast<Func<IServiceProvider, T, T2, T3, T4, T5, T6, TResult>>();
                            ...
                            public Action<IServiceProvider, T, T2, T3, T4, T5, T6> CompileCompileStatic()
                            {
                                ...
                                return lambda.CompileFast<Action<IServiceProvider, T, T2, T3, T4, T5, T6>>();
                            }
                        }
