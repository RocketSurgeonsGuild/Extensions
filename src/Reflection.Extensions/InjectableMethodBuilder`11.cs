...
public class InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9, T10> : InjectableMethodBuilderBase
{
    ...
    )
    {
        ...
        {
            return new InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, TNext>(Container, MethodName /// <summary>
            ...
            {
                return new InjectableMethodBuilder<T, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Container, MethodNames.Add(method /// <summary>
                ...
                public Func<object, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> Compile<TResult>()
                {
                    ...
                    return lambda.CompileFast < Func<object, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> > /// <summary>
                    ...
                    public Action<object, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10> Compile()
                    {
                        ...
                        return lambda.CompileFast<Action<object, IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10>>();
                        ...
                        public Func<IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> CompileStatic<TResult>()
                        {
                            ...
                            return lambda.CompileFast<Func<IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>>();
                            ...
                            public Action<IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10> CompileStatic()
                            {
                                ...
                                return lambda.CompileFast<Action<IServiceProvider, T, T2, T3, T4, T5, T6, T7, T8, T9, T10>>();
                            }
                        }
