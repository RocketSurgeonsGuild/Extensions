...
namespace Rocket.Surgery.Linq
{
    public static class AsyncLinqExtensions
    {
        ...
        /// <summary>Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IAsyncEnumerable`1" /> and flattens the resulting sequences into one sequence.</summary>
        ...
        /// <summary>Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IAsyncEnumerable`1" />, and flattens the resulting sequences into one sequence. The index of each source element is used in the projected form of that element.</summary>
        ...
        /// <summary>Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IAsyncEnumerable`1" />, flattens the resulting sequences into one sequence, and invokes a result selector function on each element therein.</summary>
        ...
        /// <summary>Projects each element of a sequence to an <see cref="T:System.Collections.Generic.IAsyncEnumerable`1" />, flattens the resulting sequences into one sequence, and invokes a result selector function on each element therein. The index of each source element is used in the intermediate projected form of that element.</summary>
        /// <returns>An <see cref="T:System.Collections.Generic.IAsyncEnumerable`1" /> whose elements are the result of invoking the one-to-many transform function <paramref name="collectionSelector" /> on each element of <paramref name="source" /> and then mapping each of those sequence elements and their corresponding source element to a result element.</returns>
        /// <param name="source">A sequence of values to project.</param>
